...
komponen utama menjadi tiga yaitu model, view dan
controller.<p>

                <ol type="a">
                <li>Model</li>
<p align='justify'>Model adalah kelas yang merepresentasikan atau
memodelkan tipe data yang akan digunkan oleh aplikasi. Model juga
dapat didefinisikan sebagai bagian dari penanganan yang berhubungan
...
<li>View</li>
<p align='justify'>View Merupakan bagian yang menangani halamana untuk
interface atau halaman yang muncul pada user(pada browser). Tampilan
dari user interface di kumpulkan pad view untuk memisahkan nya
...
menghubungkan model dan view, jadi uder tidak akan berhubungan 
...
instruksi.</P>
<p align='justify'>Dari penjelasana tentang model view dan controller
...
menggunakan konsep mvc, controller memanggil instruski pada
model yang mengambil data pada database, kemudian controller
meneruskannya pada view untuk ditampilkan. Jadi jelas sudah
sangat mudah dalam pengembangan aplikasi dengan cara mvc ini karena
web designer atau front-developer tidak perlu lagi berhubungan dengan
controller, dia hanya perlu berhubungan dengan view untuk
